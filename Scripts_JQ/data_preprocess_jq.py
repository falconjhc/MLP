...
if discrete_dim:
    ...
    pattern = continuous_pattern_scaled
...
train_data_save.to_csv('./data_ML_Exit1_Train_NoYear.csv',sep=',',index_label='-1')
test_data_save.to_csv('./data_ML_Exit1_Test_NoYear.csv',sep=',',index_label='-1')
