...
%% data input
% train_data_name='../Data/LinRui/TrainData_JHC.csv';
% test_data_name='../Data/LinRui/TestData_JHC.csv';
train_data_name='../Data/LinRui/DebugData.csv';
test_data_name='../Data/LinRui/DebugData.csv';
