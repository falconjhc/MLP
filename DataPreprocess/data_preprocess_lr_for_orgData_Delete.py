...
full_y = dataset_value[:,dim_size-1]
full_x = dataset_value[:,0:dim_size-1]

full_dim=range(0,dim_size-1)
discrete_dim = list(set(discrete_dim1).union(set(discrete_dim2)))
continuous_dim = [ii for ii in full_dim if ii not in discrete_dim]


discrete_pattern1 = get_dimension_data(full_x=full_x,
                                       selected_dim=discrete_dim1)
discrete_pattern2 = get_dimension_data(full_x=full_x,
                                       selected_dim=discrete_dim2)
