...
#training_mode=0: train from stratch
#training_mode=1: train from a pre-trained model
#training_mode=2: only evaluation

input_args = ['--exp_name','Debug',
              '--dimension_count','20',
              '--train_data_path','../Data/DebugData.csv',
              '--test_data_path','../Data/DebugData.csv',
